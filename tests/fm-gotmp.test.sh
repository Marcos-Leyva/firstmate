...
make_fake_root() {
  ...
  # fm-project-base-branch-lib.sh: teardown sources it for per-project base-branch
  # override resolution.
  ln -s "$ROOT/bin/fm-project-base-branch-lib.sh" "$fake/bin/fm-project-base-branch-lib.sh"
